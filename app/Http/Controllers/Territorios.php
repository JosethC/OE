...
class Territorios extends Controller
{
    public function getAll() {
        $territorios = Territorio::join('cantones', 'cantones.id', '=', 'territorios.canton_id')
            ->select('territorios.id', 'territorios.nombre', 'territorios.region_id', 'cantones.nombre as nombreCanton')
            ->get();
        return $territorios;
    }
