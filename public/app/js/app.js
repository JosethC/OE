        ...
        function checkStatus() {
            ...
            if ($location.path() !== '/' && typeof($cookies.get('session')) === "undefined") {
                ...
                if($cookies.getObject('session').tipo === 'A') {
                    if ($location.path() === '/admin/analisis' || $location.path() === '/') {
                        $location.path('admin/analisis');
                    }
                }
                else if($cookies.getObject('session').tipo === 'B') {
                    if ($location.path() === '/empresario/analisis' || $location.path() === '/') {
                        $location.path('empresario/analisis');
                    }
                }
                else if($cookies.getObject('session').tipo === 'E') {
                    if ($location.path() === '/encuestador/encuestas' || $location.path() === '/') {
                        $location.path('encuestador/encuestas');
                    }
                }
            }
        }
