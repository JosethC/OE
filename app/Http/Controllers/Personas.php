...
class Personas extends Controller
{
    ...
    public function logIn(Request $request) {
        $persona = Persona::where('email', $request->input('email'))->where('contrasena', md5($request->input('contrasena')))->select('id', 'cedula', 'nombre', 'apellido1', 'apellido2', 'email', 'tipo')->get();
        return $persona;
        //return Persona::all();
    }
